...
class TradeBoxTal extends StatefulWidget {
  const TradeBoxTal({Key? key}) : super(key: key);

  @override
  State<TradeBoxTal> createState() => _TradeBoxTalState();
}

class _TradeBoxTalState extends State<TradeBoxTal> {
  @override
